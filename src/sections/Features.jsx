      ...
      <Element name="Features" className="w-full">
        ...
        <div className="max-w-6xl mx-auto justify-center px-6 grid grid-cols-1 md:grid-cols-3 mt-80 gap-12">
          ...
          <div className="md:col-span-1 justify-self-start sticky top-8 self-start -translate-x-40 max-lg:translate-x-0 max-[1390px]:-translate-x-20 max-[768px]:hidden">
            <div className="bg-gray-100 backdrop-blur-md rounded-xl lg:w-80 p-5 mt-40 tracking-wide drop-shadow-3xl shadow-black-100/40 shadow-md max-[850px]:-translate-x-20  max-[1420px]:w-70 max-[1420px]:ml-7 ">
              {FeaturesData.map((feature, index) => (
                <h3
                  key={feature.id}
                  ref={index === 0 ? targetRefs[0] : null}
          ...
          <div className="md:col-span-2 justify-self-center flex flex-col ">
            {FeaturesData.map((feature, idx) => (
              ...
              >
                <div
                  className="video-card max-lg:w-100 max-lg:h-90 max-[1390px]:h-120 max-[1390px]:w-100 max-md:h-100 max-md:w-100"
                  id={feature.id}
                >
                  <video
                    ref={idx === 0 ? targetRefs[1] : null}
                ...
                <div
                  ref={idx === 0 ? targetRefs[2] : null}
                  className="bg-white/80 backdrop-blur-sm rounded-2xl max-[1390px]:-translate-x-14 drop-shadow-3xl shadow-black-100/40 max-[1024px]:translate-x-0 p-5 shadow-md w-80 shrink-0 hover:-translate-y-4 transition-all duration-200"
                >
